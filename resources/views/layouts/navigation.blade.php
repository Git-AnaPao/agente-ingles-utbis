{{--
    Barra de Navegación — Style Guide §Barra de Navegación Inferior
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="{{ route('dashboard') }}" class="shrink-0 flex items-center gap-2 me-8"
                   aria-label="Inicio Agente Inglés">
                    <span class="text-2xl" role="img" aria-label="Búho tutor">🦉</span>
                    <span class="font-display font-bold text-white text-sm hidden sm:block">
                        Agente Inglés
                    </span>
                </a>
                ...
                <div class="hidden space-x-1 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 me-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-white/90 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/40 transition duration-150"
                            ...
                            <span class="text-[10px] px-1.5 py-0.5 rounded-full font-semibold uppercase"
                                  style="background: rgba(255,255,255,0.2); color: rgba(255,255,255,0.9);">{{ Auth::user()->role }}</span>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-white/70 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/40 transition duration-150"
        ...
        <div class="pt-4 pb-3 border-t" style="border-color: var(--color-accent);">
            <div class="px-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full font-semibold uppercase inline-block mt-0.5"
                          style="background: rgba(255,255,255,0.2); color: rgba(255,255,255,0.9);">{{ Auth::user()->role }}</span>
                </div>
            </div>
