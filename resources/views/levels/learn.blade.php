        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl bg-white shadow-sm p-8">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 class="font-display font-bold text-xl" style="color: #27594B;">
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="rounded-xl p-5" style="background: #F0FFF4; border: 1px solid #C6F6D5;">
                        <p class="text-sm font-semibold" style="color: #22543D;">
