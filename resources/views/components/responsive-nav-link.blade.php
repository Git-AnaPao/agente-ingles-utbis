{{--
    Enlace de navegación responsive — Style Guide §Verde Oscuro + §Amarillo
--}}
@props(['active'])
...
$style = ($active ?? false)
    ? 'border-color:#F2B950; background-color:rgba(255,255,255,0.1); font-family:Inter,sans-serif;'
